...
@section('title')
    Dictamen de equipos - Detalles | Sistema de inventario
@endsection
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h1 class="panel-title">Datos del equipo</h1>
                        </div>
                ...
                <div class="form-group pull-left">
                    <a class="btn btn-success btn-close" href="{{ route('readDictumsEq') }}">Regresar</a>
                </div>
            </div>
        </div>
    @endif
