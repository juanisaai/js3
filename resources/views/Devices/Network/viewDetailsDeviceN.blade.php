...
@section('title')
    Dispositivos - Detalles | Sistema de inventario
@endsection
...
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="det-Title">
                        <a href="{{ route('editDeviceN', ['id' => $device->id]) }}" class="det-Title"><button type="button" class="btn btn-warning btn-sm">Editar</button></a>
                    </div>

                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h1 class="panel-title">Datos generales del dispositivo</h1>
                        </div>
    ...
    @endif
                    ...
                    <div class="form-group pull-left">
                        <a class="btn btn-success btn-close" href="{{ route('readDeviceN') }}">Regresar</a>
                    </div>
