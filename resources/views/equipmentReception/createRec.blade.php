...
@section('title')
    Recepción de equipos - Crear | Sistema de inventario
@endsection
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::textarea('AccessoryAdd', null, ['class' => 'form-control', 'placeholder' => 'Escribe los accesorios adicionales', 'rows' => 3, 'cols' => 40]) !!}
                    </div>
